...
public class ProductModelTest {
    ...
    void testProductGettersAndSetters() {
        ...
        productModel.setNama("Test Product");
        ...
        assertThat(productModel.getNama()).isEqualTo("Test Product");
    ...
    void testProductConstructor() {
        ProductModel productModel = new ProductModel(1L, 100, 100, "Test Product", "Test Description", "http://test.link");
        assertThat(productModel.getId()).isEqualTo(1L);
        assertThat(productModel.getHarga()).isEqualTo(100);
        assertThat(productModel.getNama()).isEqualTo("Test Product");
        assertThat(productModel.getDeskripsi()).isEqualTo("Test Description");
